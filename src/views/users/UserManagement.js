...
const UserManagement = () => {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        searchCriteria.roleId && (params.roleId = searchCriteria.roleId)
    ...
    const columns1 = [
      {
        ...
        render: (_, { user_id }) => (
          <CFormCheck
            checked={checkedState[user_id]}
            id="checkboxNoLabel"
            value={user_id}
            aria-label="..."
            onChange={() => handleIdCBChange(user_id)}
          />
        ),
        renderColumn: () => (
          <CFormCheck
        ...
        render: (_, { user_id }) => (
          <div className="d-flex justify-content-center">
            <CDropdown variant="btn-group">
              ...
              <CDropdownMenu>
                <NavLink className="text-nodecorate" to={`../users/${user_id}`}>
                  <CDropdownItem>Xem chi tiết</CDropdownItem>
                </NavLink>
                <NavLink className="text-nodecorate" to={`../users/${user_id}/edit`}>
                  <CDropdownItem>Sửa tài khoản</CDropdownItem>
                </NavLink>
              </CDropdownMenu>
            </CDropdown>
          </div>
  ...
  // Handle delete users when click delete all
  ...
  const handleDeleteAllClick = () => {
    ...
    if (isAnySelect) {
      ...
      setConfirmAction(() => handleDeleteUsers)
      ...
      <CRow>
        <CCol xs={12}>
          <CCard className="mb-4 card-custom">
            <CCardHeader>
              <div className="header-title-custom">Quản lý tài khoản</div>
                ...
                <CRow>
                  <CCol xs={6} className="mt-1">
                    <CFormFloating>
                      ...
                      <CFormLabel htmlFor="inputStatus">Vai trò</CFormLabel>
                    </CFormFloating>
                  </CCol>
                  <CCol xs={6} className="mt-1">
                    <CFormFloating>
