...
const FaqQuestionManagement = () => {
  ...
  useEffect(() => {
    ...
    const getFaqs = async () => {
      const response = await contentApi.fetchFaq({ params })
    ...
    const columns1 = [
      {
        ...
        render: (_, { faq_id }) => (
          <CFormCheck
            checked={checkedState[faq_id]}
            id="checkboxNoLabel"
            value={faq_id}
            aria-label="..."
            onChange={() => handleIdCBChange(faq_id)}
          />
        ),
        renderColumn: () => (
          <CFormCheck
        ...
        render: (_, { faq_id }) => (
          <div className="d-flex justify-content-center">
            <CDropdown variant="btn-group" className="dropdown-btn-group">
              ...
              <CDropdownMenu>
                <NavLink className="text-nodecorate" to={`../content/faq/${faq_id}/edit`}>
                  <CDropdownItem>Sửa câu hỏi</CDropdownItem>
                </NavLink>
              </CDropdownMenu>
            </CDropdown>
          </div>
      ...
      <CRow>
        <CCol xs={12}>
          <CCard className="mb-4 card-custom">
            <CCardHeader>
              <div className="header-title-custom">Quản lý câu hỏi thường gặp (Faqs)</div>
                ...
                <CRow className="justify-content-between">
                  ...
                  <CCol lg={6} md={6} sm={8}>
                    <CRow className="justify-content-end gap-2">
                      <CCol xl={5} lg={5} md={6} sm={6} xs={12}>
                        <NavLink to="../content/faq/create">
...
export default FaqQuestionManagement
